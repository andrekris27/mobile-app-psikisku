...
public class Booking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        String txtPsikolog = i.getStringExtra("nama_psikolog");
        txtDoctor.setText(txtPsikolog);
        ...
        btnPilihVia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alertDialog2 = new AlertDialog.Builder(Booking.this);
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i =new Intent(Booking.this, Appoinment.class);
                i.putExtra("waktu", txtWaktu.getText().toString());
                i.putExtra("via", txtVia.getText().toString());
                i.putExtra("nama_psikolog", txtDoctor.getText().toString());
                startActivity(i);
            }
        });
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i =new Intent(Booking.this, Psikolog.class);
                startActivity(i);
            }
        });
    }
